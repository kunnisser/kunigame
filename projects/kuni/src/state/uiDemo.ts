...
import KnMenuBar from "ts@/kuni/lib/gameui/kn_menubar";
...
class UIDemo extends KnScene {
  ...
  constructor(game: Game, key: string) {
    ...
    this.resources = {
      ...
      "panelTitle": "/projects/kuni/assets/images/paneltitle.png",
      "close": "/projects/kuni/assets/images/close.png",
      "profile": "/projects/kuni/assets/images/avator.jpg",
      "weapon_able": "/projects/kuni/assets/images/weapon_able.png",
      "menu01": "/projects/kuni/assets/images/menu01.png",
      "menu02": "/projects/kuni/assets/images/menu02.png",
      "menu03": "/projects/kuni/assets/images/menu03.png",
      "menu04": "/projects/kuni/assets/images/menu04.png",
      "menu05": "/projects/kuni/assets/images/menu05.png",
      "menutip": "/projects/kuni/assets/images/tip.png",
      "ui_00": "/projects/kuni/assets/images/ui_00.png",
      "ui_01": "/projects/kuni/assets/images/ui_01.png",
      "ui_02": "/projects/kuni/assets/images/ui_02.png",
      "ui_03": "/projects/kuni/assets/images/ui_03.png",
      "ui_04": "/projects/kuni/assets/images/ui_04.png",
      "ui_05": "/projects/kuni/assets/images/ui_05.png",
      "ui_06": "/projects/kuni/assets/images/ui_06.png",
      "ui_07": "/projects/kuni/assets/images/ui_07.png",
      "ui_08": "/projects/kuni/assets/images/ui_08.png",
      "ui_09": "/projects/kuni/assets/images/ui_09.png"
    };
  }
  ...
  addScrollMenu() {
    const options = [
      {
        ...
        callback: () => {
          this.game.sceneManager.changeScene(
            this,
            this.game.sceneManager.scenes["home"]
          );
        }
      },
      {
    ...
    const bgRect = this.game.add
      ...
      .generateRect(
        0xffffff,
        [0, 0, this.game.config.width, this.game.config.height - 100],
        !0
      );
  ...
  generateRankItem(data: any, index: number, modal: KnModal) {
    ...
    const itemBg = this.game.add
      .graphics()
      .generateRect(0xb89254, [0, item_y, modal.contentWidth, 30, 10]);
    const name = this.game.add.text(
      "",
      data.name,
      {
        fontSize: 12,
    ...
    const rankIndex = this.game.add.text(
      "",
      index + 1 + ".",
      {
        fontSize: 12,
    ...
    const rankValue = this.game.add.text(
      "",
      "小鱼干: " + data.star,
      {
        fontSize: 8,
  ...
  addFootbar() {
    ...
    footbar.setPosition(
      ...
      this.game.config.height - footbar.height * 0.5
    );
  }

  addTopbar() {
    const topbar = new KnMenuBar(
      this.game,
      this,
      [
        {
    ...
    topbar.setPosition(
      this.game.config.width - topbar.width * 0.5,
      topbar.height * 0.5
    );
  }
}
