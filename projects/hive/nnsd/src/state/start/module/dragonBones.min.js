/**
 * @Author: kunnisser
 * @Date: 2023-12-02 17:19:11
 * @LastEditors: kunnisser
 * @LastEditTime: 2023-12-02 17:21:30
 * @FilePath: \kunigame\projects\hive\nnsd\src\state\start\module\dragonBones.min.js
 * @Description: ----  ----
 */
...
(function (t) {
  var e = (function (e) {
    ...
    t.prototype.addBoneTimeline = function (t, e) {
      var a =
        t in this.boneTimelines
          ? this.boneTimelines[t]
          : (this.boneTimelines[t] = []);
      if (a.indexOf(e) < 0) {
        a.push(e);
      }
    ...
    t.prototype.addSlotTimeline = function (t, e) {
      var a =
        t in this.slotTimelines
          ? this.slotTimelines[t]
          : (this.slotTimelines[t] = []);
      if (a.indexOf(e) < 0) {
        a.push(e);
      }
  ...
  var t = (function (e) {
    ...
    t.prototype._updateGlobalTransformMatrix = function (t) {
      ...
      if (u) {
        ...
        var p = _
          ? o._getGlobalTransformMatrix(a.x, a.y)
          : o.globalTransformMatrix;
      ...
      if (t >= 0 && this._cachedFrameIndices !== null) {
        ...
        if (e >= 0 && this._cachedFrameIndex === e) {
          ...
          if (this._hasConstraint) {
            for (
              var a = 0, r = this._armature._constraints;
              a < r.length;
              a++
            ) {
              var i = r[a];
...
(function (t) {
  var e = (function (l) {
    ...
    P.prototype._getAffineTransform = function (
      t,
      e,
      a,
      r,
    ...
    P.prototype.init = function (t, e) {
      ...
      var r = t.segmentY;
      var i =
        this._armature.armatureData.parent.intArray[t.geometry.offset + 0];
      var n = 1e3;
      var s = 200;
      this._dX = (s * 2) / a;
      this._dY = (s * 2) / r;
...
(function (X) {
  ...
  var e = (function (t) {
    ...
    e.prototype._computeB = function () {
      ...
      i.rotation =
        ...
        p -
        c +
        X.Transform.normalizeRadian(M - E - p) * this._weight;
      i.toMatrix(n);
    };
  ...
  var a = (function (e) {
    ...
    t.prototype.addCurvePosition = function (
      t,
      e,
      a,
      r,
    ...
    t.prototype.update = function () {
      ...
      if (
        t._geometryData === null ||
        t._geometryData.offset !== this.pathOffset
      ) {
        return;
      }
      ...
      this._computeBezierCurve(
        t._displayFrame.rawDisplayData,
        f,
        h,
        r === 1,
        i === 2
      ...
      if (this._animationStates.length > 0) {
        ...
        for (var l = 0, h = this._animationStates.length; l < h; ++l) {
          if (s.layer > this._animationStates[l].layer) {
            ...
            l !== h - 1 &&
            s.layer > this._animationStates[l + 1].layer
          ) {
            o = true;
  ...
  var t = (function (e) {
        ...
        for (var t = 0, e = this._armature._constraints; t < e.length; t++) {
          ...
          if (r !== null) {
            for (var i = 0, n = r; i < n.length; i++) {
              ...
              switch (s.type) {
                case 30: {
                  var o = L.BaseObject.borrowObject(
                    L.IKConstraintTimelineState
                  );
                  o.target = a;
    ...
    t.prototype._updateBoneAndSlotTimelines = function () {
      {
        ...
        for (var o = 0, l = this._armature.getBones(); o < l.length; o++) {
          ...
          if (i in t) {
            ...
            var f = this._armature.animation.getBlendState(
              V.BONE_TRANSFORM,
              h.name,
              h
            );
    ...
    t.prototype._advanceFadeTime = function (t) {
      ...
      if (this._subFadeState > 0) {
        ...
        if (a) {
          var r = e
            ? L.EventObject.FADE_OUT_COMPLETE
            : L.EventObject.FADE_IN_COMPLETE;
          if (this._armature.eventDispatcher.hasDBEventListener(r)) {
            var i = L.BaseObject.borrowObject(L.EventObject);
            i.type = r;
            i.armature = this._armature;
    ...
    t.prototype.addState = function (t, e) {
      ...
      if (e !== null) {
        for (var a = 0, r = e; a < r.length; a++) {
          ...
          switch (i.type) {
            case 40: {
              var n = L.BaseObject.borrowObject(
                L.AnimationProgressTimelineState
              );
              n.target = t;
            ...
            case 42: {
              var n = L.BaseObject.borrowObject(
                L.AnimationParametersTimelineState
              );
              n.target = t;
              n.init(this._armature, this, i);
              this._animationTimelines.push(n);
  ...
  var n = (function (o) {
    ...
    t.prototype._onArriveAtFrame = function () {
      ...
      if (this._timelineData !== null) {
        ...
        var i =
          this._valueOffset + this._frameValueOffset + this._frameIndex * t;
        if (this._isTween) {
          var n =
            this._frameIndex === this._frameCount - 1
              ? this._valueOffset + this._frameValueOffset
      ...
      if (this._animationState.actionEnabled) {
        ...
        for (var n = 0; n < r; ++n) {
          ...
          if (o.type === 0) {
            ...
            var h =
              o.type === 10
                ? y.EventObject.FRAME_EVENT
                : y.EventObject.SOUND_EVENT;
...
(function (tt) {
  var t = (function (e) {
    ...
    $.prototype._parseArmature = function (t, e) {
      ...
      a.frameRate = $._getNumber(
        t,
        tt.DataParser.FRAME_RATE,
        this._data.frameRate
      );
      a.scale = e;
      if (
        tt.DataParser.TYPE in t &&
        typeof t[tt.DataParser.TYPE] === 'string'
      ) {
      ...
      if (tt.DataParser.DEFAULT_ACTIONS in t) {
        var z = this._parseActionData(
          t[tt.DataParser.DEFAULT_ACTIONS],
          0,
          null,
          null
        );
    ...
    $.prototype._parseBone = function (t) {
      ...
      if (e === 0) {
        ...
        r.inheritTranslation = $._getBoolean(
          t,
          tt.DataParser.INHERIT_TRANSLATION,
          true
        );
        r.inheritRotation = $._getBoolean(
          t,
          tt.DataParser.INHERIT_ROTATION,
          true
        );
        r.inheritScale = $._getBoolean(t, tt.DataParser.INHERIT_SCALE, true);
        r.inheritReflection = $._getBoolean(
          t,
          tt.DataParser.INHERIT_REFLECTION,
          true
        );
    ...
    $.prototype._parsePathConstraint = function (t) {
      ...
      var r = a.getDisplay(
        e.name,
        $._getString(t, tt.DataParser.TARGET_DISPLAY, e.name)
      );
    ...
    $.prototype._parseSlot = function (t, e) {
      ...
      a.name = $._getString(t, tt.DataParser.NAME, '');
      a.parent = this._armature.getBone(
        $._getString(t, tt.DataParser.PARENT, '')
      );
      if (
        tt.DataParser.BLEND_MODE in t &&
        typeof t[tt.DataParser.BLEND_MODE] === 'string'
      ) {
    ...
    $.prototype._parseDisplay = function (t) {
      ...
      switch (r) {
        ...
        case 2: {
          ...
          p.geometry.inheritDeform = $._getBoolean(
            t,
            tt.DataParser.INHERIT_DEFORM,
            true
          );
          p.name = e;
        ...
        case 4: {
          ...
          v.constantSpeed = $._getBoolean(
            t,
            tt.DataParser.CONSTANT_SPEED,
            false
          );
          v.name = e;
    ...
    $.prototype._parseBoundingBox = function (t) {
      ...
      var a = 0;
      if (
        tt.DataParser.SUB_TYPE in t &&
        typeof t[tt.DataParser.SUB_TYPE] === 'string'
      ) {
    ...
    $.prototype._parseTweenFrame = function (t, e, a) {
      ...
      if (a > 0) {
        if (tt.DataParser.CURVE in t) {
          ...
          var n = this._samplingEasingCurve(
            t[tt.DataParser.CURVE],
            this._helpArray
          );
    ...
    $.prototype._parseBoneAllFrame = function (t, e, a) {
      ...
      if (e !== 0) {
        if (this._prevClockwise === 0) {
          r =
            this._prevRotation +
            tt.Transform.normalizeRadian(r - this._prevRotation);
        } else {
          if (
    ...
    $.prototype._parseIKConstraintFrame = function (t, e, a) {
      ...
      var i = this._frameIntArray.length;
      this._frameIntArray.length += 2;
      this._frameIntArray[i++] = $._getBoolean(
        t,
        tt.DataParser.BEND_POSITIVE,
        true
      )
        ? 1
        : 0;
      this._frameIntArray[i++] = Math.round(
        $._getNumber(t, tt.DataParser.WEIGHT, 1) * 100
      );
      return r;
    };
      ...
      if (typeof t === 'string') {
        ...
        for (var s = 0, o = t; s < o.length; s++) {
          ...
          if (tt.DataParser.GOTO_AND_PLAY in l) {
            ...
            if (
              tt.DataParser.TYPE in l &&
              typeof l[tt.DataParser.TYPE] === 'string'
            ) {
    ...
    $.prototype._parseColorTransform = function (t, e) {
      e.alphaMultiplier =
        $._getNumber(t, tt.DataParser.ALPHA_MULTIPLIER, 100) * 0.01;
      e.redMultiplier =
        $._getNumber(t, tt.DataParser.RED_MULTIPLIER, 100) * 0.01;
      e.greenMultiplier =
        $._getNumber(t, tt.DataParser.GREEN_MULTIPLIER, 100) * 0.01;
      e.blueMultiplier =
        $._getNumber(t, tt.DataParser.BLUE_MULTIPLIER, 100) * 0.01;
...
(function (g) {
  var t = (function (o) {
    ...
    t.prototype._parseAnimation = function (t) {
      ...
      e.playTimes = g.ObjectDataParser._getNumber(
        t,
        g.DataParser.PLAY_TIMES,
        1
      );
      e.duration = e.frameCount / this._armature.frameRate;
      e.fadeInTime = g.ObjectDataParser._getNumber(
        t,
        g.DataParser.FADE_IN_TIME,
        0
      );
      e.scale = g.ObjectDataParser._getNumber(t, g.DataParser.SCALE, 1);
      e.name = g.ObjectDataParser._getString(
        t,
        g.DataParser.NAME,
        g.DataParser.DEFAULT_NAME
      );
      if (e.name.length === 0) {
      ...
      if (g.DataParser.Z_ORDER in t) {
        e.zOrderTimeline = this._parseBinaryTimeline(
          1,
          t[g.DataParser.Z_ORDER]
        );
      }
        ...
        for (var f = 0, _ = h.displayList; f < _.length; f++) {
          ...
          if (m instanceof y.Armature) {
            ...
            if (p !== null && u < p.length) {
              var c = p[u];
              if (c !== null && c.type === 1) {
                var d = this.getArmatureData(
                  c.path,
                  c.parent.parent.parent.name
                );
                if (d) {
  ...
  var t = (function (t) {
      ...
      if (this._displayIndex >= 0 && this._display !== null && t !== null) {
        ...
        if (a !== null) {
          if (this._geometryData !== null) {
            ...
            this._textureScale =
              t.parent.scale * this._armature._armatureData.scale;
    ...
    e.prototype._updateMesh = function () {
      ...
      if (i !== null) {
        ...
        for (
          var _ = 0, m = 0, p = i.offset + 2 + a.length, c = f, d = 0;
          _ < u;
          ++_
        ) {
          var y = l[p++];
  ...
  var t = (function (i) {
    ...
    n._clockHandler = function (t) {
      this._dragonBonesInstance.advanceTime(
        (t / PIXI.settings.TARGET_FPMS) * 0.001
      );
    };
